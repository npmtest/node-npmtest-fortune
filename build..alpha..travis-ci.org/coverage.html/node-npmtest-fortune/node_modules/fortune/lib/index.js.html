...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fortune/node_modules/fortune/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fortune/node_modules/fortune/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">20.42% <small>(29 / 142)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fortune/node_modules/fortune/lib/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 *   will use.
 */
<span class="fstat-no" title="function not covered" >function Fortune (recordTypes, options) {</span>
<span class="cstat-no" title="statement not covered" >  if (!(this instanceof Fortune))</span>
<span class="cstat-no" title="statement not covered" >    return new Fortune(recordTypes, options)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.constructor(recordTypes, options)</span>
}
&nbsp;
&nbsp;
 ...
 * @return {Fortune}
 */
Fortune.prototype.constructor = <span class="fstat-no" title="function not covered" >function Fortune (recordTypes, options) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this</span>
<span class="cstat-no" title="statement not covered" >  var plainObject = {}</span>
<span class="cstat-no" title="statement not covered" >  var adapter, method, stack, flows, type, hooks, i, j</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (recordTypes === void 0) <span class="cstat-no" title="statement not covered" >recordTypes = {}</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!('adapter' in options)) <span class="cstat-no" title="statement not covered" >options.adapter = [ memoryAdapter(Adapter) ]</span></span>
<span class="cstat-no" title="statement not covered" >  if (!('settings' in options)) <span class="cstat-no" title="statement not covered" >options.settings = {}</span></span>
<span class="cstat-no" title="statement not covered" >  if (!('hooks' in options)) <span class="cstat-no" title="statement not covered" >options.hooks = {}</span></span>
<span class="cstat-no" title="statement not covered" >  if (!('enforceLinks' in options.settings))</span>
<span class="cstat-no" title="statement not covered" >    options.settings.enforceLinks = true</span>
&nbsp;
  // Bind middleware methods to instance.
<span class="cstat-no" title="statement not covered" >  flows = {}</span>
<span class="cstat-no" title="statement not covered" >  for (method in methods) {</span>
<span class="cstat-no" title="statement not covered" >    stack = [ middlewares[method], middlewares.include, middlewares.end ]</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (i = 0, j = stack.length; i &lt; j; i++)</span>
<span class="cstat-no" title="statement not covered" >      stack[i] = bindMiddleware(self, stack[i])</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    flows[methods[method]] = stack</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  hooks = options.hooks</span>
&nbsp;
  // Validate hooks.
<span class="cstat-no" title="statement not covered" >  for (type in hooks) {</span>
<span class="cstat-no" title="statement not covered" >    if (!recordTypes.hasOwnProperty(type)) <span class="cstat-no" title="statement not covered" >throw new Error(</span></span>
      'Attempted to define hook on "' + type + '" type ' +
      'which does not exist.')
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(hooks[type]))</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError('Hook value for "' + type + '" type ' +</span>
        'must be an array.')
  }
&nbsp;
  // Validate record types.
<span class="cstat-no" title="statement not covered" >  for (type in recordTypes) {</span>
<span class="cstat-no" title="statement not covered" >    if (type in plainObject)</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Can not define type name "' + type +</span>
        '" which is in Object.prototype.')
&nbsp;
<span class="cstat-no" title="statement not covered" >    validate(recordTypes[type])</span>
<span class="cstat-no" title="statement not covered" >    if (!hooks.hasOwnProperty(type)) <span class="cstat-no" title="statement not covered" >hooks[type] = []</span></span>
  }
&nbsp;
  /*!
   ...
   * @type {Adapter}
   */
<span class="cstat-no" title="statement not covered" >  adapter = new AdapterSingleton({</span>
...
&nbsp;
  // Internal properties.
<span class="cstat-no" title="statement not covered" >  Object.defineProperties(self, {</span>
 ...
 * @return {Promise}
 */
Fortune.prototype.request = <span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this</span>
<span class="cstat-no" title="statement not covered" >  var connectionStatus = self.connectionStatus</span>
<span class="cstat-no" title="statement not covered" >  var Promise = promise.Promise</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (connectionStatus === 0)</span>
<span class="cstat-no" title="statement not covered" >    return self.connect()</span>
    .then(<span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return dispatch.call(self, options) }</span>)
&nbsp;
  else <span class="cstat-no" title="statement not covered" >if (connectionStatus === 1)</span>
...
<span class="cstat-no" title="statement not covered" >      self.once(events.failure, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        reject(new Error('Connection failed.'))</span>
      })
<span class="cstat-no" title="statement not covered" >      self.once(events.connect, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        resolve(dispatch.call(self, options))</span>
      })
    })
&nbsp;
<span class="cstat-no" title="statement not covered" >  return dispatch.call(self, options)</span>
}
&nbsp;
&nbsp;
/**
 ...
 * @return {Promise}
 */
Fortune.prototype.find = <span class="fstat-no" title="function not covered" >function (type, ids, options, include, meta) {</span>
<span class="cstat-no" title="statement not covered" >  var obj = { method: methods.find, type: type }</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (ids) <span class="cstat-no" title="statement not covered" >obj.ids = Array.isArray(ids) ? ids : [ ids ]</span></span>
<span class="cstat-no" title="statement not covered" >  if (options) <span class="cstat-no" title="statement not covered" >obj.options = options</span></span>
<span class="cstat-no" title="statement not covered" >  if (include) <span class="cstat-no" title="statement not covered" >obj.include = include</span></span>
<span class="cstat-no" title="statement not covered" >  if (meta) <span class="cstat-no" title="statement not covered" >obj.meta = meta</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.request(obj)</span>
}
&nbsp;
&nbsp;
/**
 ...
 * @return {Promise}
 */
Fortune.prototype.create = <span class="fstat-no" title="function not covered" >function (type, records, include, meta) {</span>
<span class="cstat-no" title="statement not covered" >  var options = { method: methods.create, type: type,</span>
    payload: Array.isArray(records) ? records : [ records ] }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (include) <span class="cstat-no" title="statement not covered" >options.include = include</span></span>
<span class="cstat-no" title="statement not covered" >  if (meta) <span class="cstat-no" title="statement not covered" >options.meta = meta</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.request(options)</span>
}
&nbsp;
&nbsp;
/**
 ...
 * @return {Promise}
 */
Fortune.prototype.update = <span class="fstat-no" title="function not covered" >function (type, updates, include, meta) {</span>
<span class="cstat-no" title="statement not covered" >  var options = { method: methods.update, type: type,</span>
 ...
 * @return {Promise}
 */
Fortune.prototype.delete = <span class="fstat-no" title="function not covered" >function (type, ids, include, meta) {</span>
<span class="cstat-no" title="statement not covered" >  var options = { method: methods.delete, type: type }</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (ids) <span class="cstat-no" title="statement not covered" >options.ids = Array.isArray(ids) ? ids : [ ids ]</span></span>
<span class="cstat-no" title="statement not covered" >  if (include) <span class="cstat-no" title="statement not covered" >options.include = include</span></span>
<span class="cstat-no" title="statement not covered" >  if (meta) <span class="cstat-no" title="statement not covered" >options.meta = meta</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.request(options)</span>
 ...
 * @return {Promise}
 */
Fortune.prototype.connect = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var self = this</span>
<span class="cstat-no" title="statement not covered" >  var Promise = promise.Promise</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (self.connectionStatus === 1)</span>
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Connection is in progress.'))</span>
&nbsp;
  else <span class="cstat-no" title="statement not covered" >if (self.connectionStatus === 2)</span>
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Connection is already done.'))</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  self.connectionStatus = 1</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(self, 'denormalizedFields', {</span>
      value: ensureTypes(self.recordTypes),
      writable: true,
      configurable: true
    })
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.adapter.connect().then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      self.connectionStatus = 2</span>
<span class="cstat-no" title="statement not covered" >      self.emit(events.connect)</span>
<span class="cstat-no" title="statement not covered" >      return resolve(self)</span>
    }, <span class="fstat-no" title="function not covered" >function (error) {</span>
<span class="cstat-no" title="statement not covered" >      self.connectionStatus = 0</span>
<span class="cstat-no" title="statement not covered" >      self.emit(events.failure)</span>
 ...
 * @return {Promise}
 */
Fortune.prototype.disconnect = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var self = this</span>
<span class="cstat-no" title="statement not covered" >  var Promise = promise.Promise</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (self.connectionStatus !== 2)</span>
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Instance has not been connected.'))</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  self.connectionStatus = 1</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >    return self.adapter.disconnect().then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      self.connectionStatus = 0</span>
<span class="cstat-no" title="statement not covered" >      self.emit(events.disconnect)</span>
<span class="cstat-no" title="statement not covered" >      return resolve(self)</span>
    }, <span class="fstat-no" title="function not covered" >function (error) {</span>
<span class="cstat-no" title="statement not covered" >      self.connectionStatus = 2</span>
<span class="cstat-no" title="statement not covered" >      self.emit(events.failure)</span>
...
<span class="cstat-no" title="statement not covered" >    promise.Promise = value</span>
  }
})
&nbsp;
&nbsp;
// Internal helper function.
<span class="fstat-no" title="function not covered" >function bindMiddleware (scope, method) {</span>
...
<span class="cstat-no" title="statement not covered" >    return method.call(scope, x)</span>
  }
}
&nbsp;
&nbsp;
