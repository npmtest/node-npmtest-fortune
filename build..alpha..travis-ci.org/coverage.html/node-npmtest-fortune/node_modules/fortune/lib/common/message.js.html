...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fortune/node_modules/fortune/lib/common/message.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fortune/node_modules/fortune/lib/common/message.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fortune/node_modules/fortune/lib/common/</a> &#187; message.js</div>
</div>
<div class="body">
 ...
 * @return {String}
 */
<span class="fstat-no" title="function not covered" >function message (id, language, data) {</span>
<span class="cstat-no" title="statement not covered" >  var str, key, subtag</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!message.hasOwnProperty(language)) {</span>
<span class="cstat-no" title="statement not covered" >    subtag = language &amp;&amp; language.match(/.+?(?=-)/)</span>
<span class="cstat-no" title="statement not covered" >    if (subtag) <span class="cstat-no" title="statement not covered" >subtag = subtag[0]</span></span>
<span class="cstat-no" title="statement not covered" >    if (message.hasOwnProperty(subtag)) <span class="cstat-no" title="statement not covered" >language = subtag</span></span>
    else <span class="cstat-no" title="statement not covered" >language = message.defaultLanguage</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!message[language].hasOwnProperty(id))</span>
<span class="cstat-no" title="statement not covered" >    return message[language][genericMessage] || message.en[genericMessage]</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  str = message[language][id]</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (key in data) <span class="cstat-no" title="statement not covered" >str = str.replace('{' + key + '}', data[key])</span></span>
&nbsp;
